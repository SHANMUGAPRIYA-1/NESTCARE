...
const recipes = [
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2017/09/iStock-626393768_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2017/06/iStock-476263007_4x3.jpg?width=1026",
    ingredients: [
      "Half cup oats (jaee)",
      "1 cup milk",
    ...
    variation:
      "For a non-cook version replace oats with packaged, ready-to-eat puffed amaranth seeds and mix with warm or cold milk. You can also replace the apple with any other fruit of your choice. Pears (nashpati), peach (adoo) apricot (khubani), sapodilla (cheeku), mango (aam) and strawberries all work well.",
  },
  {
    name: "Almond Soup",
    photo:
      "https://assets.babycenter.com/ims/2017/09/iStock-496948255_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    name: "Spinach Soup",
    photo:
      "https://assets.babycenter.com/ims/2013/08/167490957_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2017/09/iStock-497964562_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2014/10/96888500_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    name: "Harira",
    photo:
      "https://hostthetoast.com/wp-content/uploads/2019/12/Moroccan-Chickpea-Lentil-Soup-4.jpg",
    ingredients: [
      "2 tbsp desi ghee",
  ...
  },
  {
    name: "Panjiri",
    photo:
      "https://rakskitchen.net/wp-content/uploads/2022/08/panjiri-recipe.jpg",
    ingredients: [
  ...
  },
  {
    name: "Flaxseed Roti",
    photo:
      "https://assets.babycenter.com/ims/2015/09/504400371_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2017/09/iStock-520961869_4x3.jpg?width=1026",
    ingredients: [
  ...
  },
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2014/10/481711353_4x3.jpg?width=1026",
    ingredients: [
      "2 cups rice",
  ...
  },
  {
    ...
    photo:
      "https://assets.babycenter.com/ims/2014/08/463322207_4x3.jpg?width=1026",
    ingredients: [
...
const Recipes = () => {
  ...
  // ✅ Function to read full page content dynamically
  const handleSpeak = () => {
  ...
  return (
    <div>
      {/* 🔊 Voice Controls Added (Professional Style) */}
            ...
            <div className="recipe-details">
              ...
              {recipe.variation && (
                <p className="variation">
                  <strong>Variation:</strong> {recipe.variation}
                </p>
              )}
