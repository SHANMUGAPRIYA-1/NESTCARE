...
const WaterTracker = () => {
  ...
  return (
    <div className="container">
      ...
      <p>
        Drinking water is essential for maintaining good health. It helps
        regulate body temperature, keeps joints lubricated, prevents infections,
        delivers nutrients to cells, and keeps organs functioning properly.
        Staying hydrated improves sleep quality, cognition, and mood.
      </p>
