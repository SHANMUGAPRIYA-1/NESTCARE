...
const bodyCareItems = [
  {
    title: "Skin Care",
    description:"Keep your baby's skin clean and dry. Use gentle products specifically designed for babies.",
    image: "src/assets/skincare.jpg",
    themeColor: "#FFCCBC"
  },
  {
  title: "Bathing",
  description:"Bathe your baby 2-3 times a week. Use lukewarm water and mild baby soap.",
  image: "src/assets/bathing.jpg",
  themeColor: "#BBDEFB",
},
{
  title: "Umbilical Cord Care",
  description:"Keep the umbilical cord stump clean and dry until it falls off naturally.",
  image: "src/assets/umbilical_cord_care.jpg",
  themeColor: "#C8E6C9",
},
{
  title: "Nail Care",
  description:"Trim your baby's nails regularly to prevent scratches. Use baby nail clippers or a file.",
...
{
  title: "Sleeping",
  description:"Ensure the baby sleeps in a safe and comfortable environment.",
  ...
  return (
    <div style={bodyCareContainerStyle}>
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        <button onClick={handleVoice} style={buttonStyle}>
